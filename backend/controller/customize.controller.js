...
exports.notifyEvent = async (req, res) => {
  ...
  try {
    ...
    const info = await transporter.sendMail({
      from: '"Demons Shop" <namhlpde170555@fpt.edu.vn>', // sender address
      to: data.email, // list of receivers
      subject: "Our team Information", // Subject line
      text: "You have a new notification from Demons.", // plain text body
      html: `
      ...
      <div style="text-align: center; padding: 20px; background: linear-gradient(90deg, #64B5F6 0%, #81D4FA 100%); color: #ffffff; border-radius: 10px 10px 0 0;">
        <h2 style="margin: 0; font-size: 28px;">🎉 Our team information 🎉</h2>
      </div>
          <div style="padding: 20px;">
            <p style="font-size: 18px; color: #333;">Hello,</p>
            <p style="font-size: 16px; color: #333; margin-bottom: 20px;">
              We are excited to inform you about our team information . Don't miss out on our exclusive offers and discounts!
            </p>
            <div style="background-color: #e3f2fd; padding: 20px; border-radius: 10px; margin: 20px 0; border-left: 5px solid #1e88e5;">
              <p style="font-size: 18px; color: #1e88e5; font-weight: bold;">Our Team Details:</p>
              <ul style="font-size: 16px; color: #333; list-style-type: none; padding: 0; margin: 0;">
                <li style="margin-bottom: 10px;">
                  <strong>🔥 Website:</strong> <span style="color: #e91e63;">Demons Shop</span> for eccormerce website.
                </li>
                <li style="margin-bottom: 10px;">
                  <strong>🔥 Address:</strong> FPT Urban Area, Ngu Hanh Son, Da Nang.
                </li>
                <li style="margin-bottom: 10px;">
                  <strong>🔥 Email:</strong> namhlpde170555@fpt.edu.vn.
                </li>
                <li style="margin-bottom: 10px;">
                  <strong>🔥 Zalo:</strong> 0775420232.
                </li>
              </ul>
            </div>
            <p style="font-size: 16px; color: #333; margin-bottom: 20px;">
              Make sure to visit our store or website to take team information. If you have any questions, feel free to contact our support team.
            </p>
            <p style="font-size: 16px; color: #333;">Thank you for being a valued customer!</p>
            <p style="font-size: 16px; color: #333;">Best regards,<br><span style="color: #4CAF50;">Demons Team</span></p>
            <div style="text-align: center; padding-top: 20px; border-top: 1px solid #e0e0e0; margin-top: 20px; background-color: #fafafa; padding: 10px; border-radius: 0 0 10px 10px;">
              <p style="font-size: 14px; color: #999; margin: 0;">Demons Team, FPT Urban Area, Ngu Hanh Son, Da Nang</p>
              <p style="font-size: 14px; color: #999; margin: 0;">Email: namhlpde170555@fpt.edu.vn | Zalo: 0775420232</p>
            </div>
          </div>
        </div>
      `, // html body
